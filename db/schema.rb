...
ActiveRecord::Schema.define(version: 20160704045151) do
  ...
  add_index "ratings", ["startup_id"], name: "index_ratings_on_startup_id", using: :btree
  ...
  add_index "subscriptions", ["startup_id"], name: "index_subscriptions_on_startup_id", using: :btree
